...
export default function ConcertacionPrediccionModal( props ) {
	...
	const prediccionConcertacion = async () => {
		
		await axios({
			method: 'get',
			url: "/concertacion/prediccion_concertacion/" + props.concertacion.id_conc_tema,
			headers: {
