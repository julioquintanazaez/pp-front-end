...
export default function ConcertacionAdicionar ( ) {
	...
	const validationRules = Yup.object().shape({		
		...
		conc_descripcion: Yup.string().trim()
			.required("Se requiere la descripci�n para la concertacion"),
		conc_valoracion_prof: Yup.string().trim()
			.required("Se requiere la valoraci�n del profesor para la concertacion"),
		conc_valoracion_cliente: Yup.string().trim()
			.required("Se requiere la valoraci�n del cliente para la concertacion"),
		...
		<>
			<form className="form-control" onSubmit={formik.handleSubmit}>
				<div className="form-group mt-3" id="conc_tema">
					...
					<input
					  ...
					  className={"form-control mt-1" + 
									...
									? "is-invalid" : "" )}
					  placeholder="Tema de la concertaci�n"
					/>					
				...
				<div className="form-group mt-3" id="conc_descripcion">
					<label>Introduzca la descripci�n para la concertacion</label>
					<textarea
					  rows="2"
					  ...
					  className={"form-control mt-1" + 
									...
									? "is-invalid" : "" )}
					  placeholder="Descripci�n para la concertacion"
					>	
					</textarea>
				...
				<div className="form-group mt-3" id="conc_valoracion_prof">
					<label>Introduzca la valoraci�n del profesor para la concertacion</label>
					<textarea
					  rows="2"
					  ...
					  className={"form-control mt-1" + 
									...
									? "is-invalid" : "" )}
					  placeholder="Valoraci�n del profesor para la concertacion"
					>		
					</textarea>
				...
				<div className="form-group mt-3" id="conc_valoracion_cliente">
					<label>Introduzca valoraci�n del cliente para la concertacion</label>
					<textarea
					  rows="2"
					  ...
					  className={"form-control mt-1" + 
									...
									? "is-invalid" : "" )}
					  placeholder="Valoraci�n del cliente para la concertacion"
					>	
					</textarea>
				...
				<div className="form-group mt-3" id="conc_actores_externos">
					<label>Introduzca el n�mero de actores externos para la concertacion</label>
					<input
					  type="text"
					  ...
					  className={"form-control mt-1" + 
									...
									? "is-invalid" : "" )}
					  placeholder="N�mero de actores externos"
					/>					
